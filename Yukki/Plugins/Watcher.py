...
async def chat_watcher_func(_, message):
    ...
    if await is_gbanned_user(userid):
        ...
        await message.reply_text(
            f"{checking} is globally banned by Sudo Users and has been kicked out of the chat.(ノ｀Д´)ノ彡┻━┻ \n\n**Possible Reason:** Potential Spammer and Abuser or Personal issues with my Master 𝔻𝕊ℙ."
        )
